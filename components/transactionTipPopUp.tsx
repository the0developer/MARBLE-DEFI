...
import { checkTransaction } from '../util/swap'
...
export const successToast = (txHash: string) => {
  toast(
    <a
      className="text-white w-full h-full pl-1.5"
      href={`${getConfig().explorerUrl}/txns/${txHash}`}
...
export const checkAccountTip = () => {
  toast(
    ...
    >
      It seems like an error occurred while adding/removing liquidity to the
      pool
    </span>,
    {
      autoClose: false,
